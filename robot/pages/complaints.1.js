...
class Complaints {
  ...
  exec () {
    ...
    return that.nightmare
      .wait('#page-wrapper > div > div:nth-child(3) > div > table > thead > tr:nth-child(1) > td:nth-child(1) > button')
      .wait(100)
      .check('#page-wrapper > div > div:nth-child(3) > div > table > thead > tr > th:nth-child(1) > input[type="checkbox"]')
      .evaluate(function () {
        var links = []
        var checkbox = document.querySelector('#page-wrapper > div > div:nth-child(3) > div > table > thead > tr > th:nth-child(1) > input[type="checkbox"]')
        var trs = checkbox.querySelectorAll('tr')
