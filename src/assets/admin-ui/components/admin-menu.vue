<style lang="scss">
  ...
  .admin-menu {
    ...
    .collapse > .menu > .menu-fold-icon:hover {
      color: $primary;
    }
  ...
  <ul class="admin-menu" :class="isTopLevel ? 'top-level' : ''">
    <li
      ...
      <div class="menu" @click="select(item)">
        ...
        <i class="menu-fold-icon ion-chevron-down" 
          v-if="item.children && item.children.length" 
          v-show="!item.collapse"
          @click.stop="toggleCollapse(item)"></i>
        <i class="menu-fold-icon ion-chevron-right" 
          v-if="item.children && item.children.length" 
          v-show="item.collapse"
          @click.stop="toggleCollapse(item)"></i>
      </div>
  ...
  export default {
    ...
    methods: {
      ...
      setTopLevelChildrenActiveDec (item) {
        let allItems = this.isTopLevel ? this.localItems : this.allMenuItems
        allItems.forEach(it => {
