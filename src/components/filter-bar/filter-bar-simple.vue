  ...
  <div class="filter-bar-simple">
    <div class="header clearfix">
      <div class="button-area fn-fl">
        <el-button size="mini" type="primary" class="btn-filter" @click="showCon=!showCon"><i class="fa fa-filter"
                                                                                              aria-hidden="true"></i><span>过滤</span>
        </el-button>
      </div>
...
<script>
  ...
  import {InputNumber, Button, Input, Icon, Checkbox} from 'element-ui'
  export default {
    components: {
      InputNumber,
      'el-button': Button,
    ...
    methods: {
      handleAvgResponseTime (e){
        ...
        this.filterData.avgResponseTime = val
      },
      handleRpm (e){
        let val = e.target.value
        this.filterData.rpm = val
      },
      handleErrorNum (e){
        let val = e.target.value
        this.filterData.errorNum = val
      },
    }
