(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);throw new Error("Cannot find module '"+o+"'")}var f=n[o]={exports:{}};t[o][0].call(f.exports,function(e){var n=t[o][1][e];return s(n?n:e)},f,f.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
  ...
  var defaultContextKey = "default@key"
  ...
  var TWebAgentBase = function (args) {
    this.agentId = null
    this.tierId = null
    this.appId = null
    this.traceId = null
  ...
  TWebAgentBase.prototype = {}
  TWebAgentBase.prototype.read = function (input) {
      ...
      case 14:
        if (ftype == Thrift.Type.MAP) {
          ...
          for (var _i5 = 0; _i5 < _size0; ++_i5) {
            ...
            this.backupProperties[key6] = val7
          }
          input.readMapEnd()
        } else {
          input.skip(ftype)
  ...
  TWebAgentBase.prototype.write = function (output) {
    output.writeStructBegin("TWebAgentBase")
    ...
    if (this.backupProperties !== null && this.backupProperties !== undefined) {
      ...
      for (var kiter16 in this.backupProperties) {
        if (this.backupProperties.hasOwnProperty(kiter16)) {
          var viter17 = this.backupProperties[kiter16]
    ...
    if (this.backupQuota !== null && this.backupQuota !== undefined) {
      ...
      for (var kiter18 in this.backupQuota) {
        if (this.backupQuota.hasOwnProperty(kiter18)) {
          var viter19 = this.backupQuota[kiter18]
      ...
      case 10:
        if (ftype == Thrift.Type.MAP) {
          ...
          for (var _i25 = 0; _i25 < _size20; ++_i25) {
            ...
            this.backupProperties[key26] = val27
          }
          input.readMapEnd()
        } else {
          input.skip(ftype)
      ...
      case 11:
        if (ftype == Thrift.Type.MAP) {
          ...
          for (var _i33 = 0; _i33 < _size28; ++_i33) {
            ...
            val35 = input.readI64().value
            this.backupQuota[key34] = val35
          }
          input.readMapEnd()
        } else {
          input.skip(ftype)
  ...
  TWebAgentAjax.prototype.write = function (output) {
    ...
    if (this.backupProperties !== null && this.backupProperties !== undefined) {
      ...
      output.writeMapBegin(Thrift.Type.STRING, Thrift.Type.STRING, Thrift.objectLength(this.backupProperties))
      for (var kiter36 in this.backupProperties) {
        if (this.backupProperties.hasOwnProperty(kiter36)) {
          var viter37 = this.backupProperties[kiter36]
    ...
    if (this.backupQuota !== null && this.backupQuota !== undefined) {
      ...
      output.writeMapBegin(Thrift.Type.STRING, Thrift.Type.I64, Thrift.objectLength(this.backupQuota))
      for (var kiter38 in this.backupQuota) {
        if (this.backupQuota.hasOwnProperty(kiter38)) {
          var viter39 = this.backupQuota[kiter38]
   ...
   * @Last Modified by: jiangfeng
   * @Last Modified time: 2017-08-25 13:57:01
   */
  ...
  function domLoading () {
    ...
    c.id = "rx-" + new Date() * 1
    c.text = "window.$$rxApmDomLoadingStartTime=new Date() * 1;var s = document.getElementById('" + c.id + "'); document.getElementsByTagName('head')[0].removeChild(s);"
   ...
   * @Last Modified by: jiangfeng
   * @Last Modified time: 2017-08-25 13:42:21
   */
   ...
   * @Last Modified by: jiangfeng
   * @Last Modified time: 2017-08-28 22:30:03
   */
  ...
  function sendPerformances (performances) {
    ...
    protocol.writeMessageBegin("TWebAgentBase", Thrift.MessageType.CALL, 0)
    var entity = new kepler.TWebAgentBase(performances)
    ...
    if (config.openTracing) {
      options.header = {}
      options.header[consts.kepler_message_type] = consts.web_base
      options.header[consts.kepler_agent_token] = config.agentId
      options.header[consts.kepler_config_version] = config.LIB_VERSION
    }
    common.ajax(options)
  ...
  */
  ...
  var __ajaxHacker = (function () {
    ...
    return function (config) {
      ...
      if (window.ActiveXObjec) {
        XHRConstructor = window.ActiveXObjec
  ...
  },{"./xhrWrap":23}],23:[function(require,module,exports){
  /*
   * @Author: jiangfeng
   * @Date: 2017-08-22 11:30:13
   * @Last Modified by: jiangfeng
   * @Last Modified time: 2017-08-28 22:20:53
   */
  ...
  var kepler = require("../kepler")
  var xhrs = []
  /* eventEmitter.on("xhr", function (xhr, type, params) {
    switch (type) {
    case "send":
  ...
  function collect (performance) {
    var host = performance.host
    if (config.apiHost.indexOf(host) >= 0) return
  ...
  wrapXHR({
    ...
    beforeSend: function (next, body) {
      ...
      // var contentLength = typeof body === "object" || body instanceof Array ? JSON.stringify(body).length : body.length
  ...
  setInterval(function () {
    if (xhrs && xhrs.length > 0) { send(Array.prototype.splice.call(xhrs, 0, 1)[0]) }
  }, config.transFrequency)

  module.exports = eventEmitter

  },{"../common":1,"../config":2,"../consts":3,"../eventEmitter":6,"../json":9,"../kepler":10,"../log":12,"../thrift":19,"./ajaxHacker":21}]},{},[7])
